const all = {
  ...
  jp: {
    ...
    desperado: "デスペラード",
    whipBlade: "エナジーソード",
    oneHandedBluntWeapon: "片手鈍器",
    shiningRod: "シャイニングロッド",
    soulShooter: "ソウルシューター",
    staff: "棒",
    oneHandedSword: "片手剣",
    wand: "杖",
    testWeapon: "Test Weapon",
    ...
    mass: "Mass",
    foxMarble: "狐玉",
    coreController: "コントローラ",
    charges: "装薬",
    chessPiece: "チェスピース",
    transmitter: "Transmitter",
    wings: "翼",
    twoHandedWeapon: "両手武器",
    twoHandedAxe: "両手斧",
    bow: "弓",
    crossbow: "弩",
    dualBowgun: "デュアルボウガン",
